...
df = pd.read_excel("d:/New folder/TocDoAnMon_CT3_01Thang.xlsx", sheet_name=0, header=2)
...
fig.suptitle("Dữ liệu tốc độ ăn mòn Tháng 1", fontsize=22, fontweight='bold', y=0.98)
...
# So ssanhs sự tương quan giữa số ngày và tốc độ ăn mòn 
sns.scatterplot(
    data=df_clean,
    x="Số ngày",
    y="Tốc độ ăn mòn (g/cm2.ngày)",
...
plt.savefig(os.path.join(output_folder, "ketqua_bieudothang1.png"), dpi=200)
plt.show()
